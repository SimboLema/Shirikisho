...
class PaidDriverDialog extends StatefulWidget {
  static String tag = '/PaidDriverDialog';

  final Application? applicationModel;

  PaidDriverDialog({super.key, this.applicationModel});

  @override
  PaidDriverDialogState createState() => PaidDriverDialogState();
}

class PaidDriverDialogState extends State<PaidDriverDialog> {
  var plan;
  var duration;
