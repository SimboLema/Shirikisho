...
const WAPrimaryColor2 = Color(0xFF24B42E);
const WAPrimaryColor = Color.fromRGBO(0, 131, 116,1);
...
const appDeepGreen = Color.fromRGBO(36, 48, 24, 1);

// Dark Theme Colors
const appBackgroundColorDark = Color(0xFF121212);
const appBackgroundColorBlack = black;
