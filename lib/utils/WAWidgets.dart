...
InputDecoration humtechKataImput(
    {IconData? prefixIcon,
    String? hint,
    Color? bgColor,
    Color? borderColor,
      ...
      child: Observer(
        builder: (context) => DropdownButtonHideUnderline(
          child: DropdownButton(
            ...
            items: [
              DropdownMenuItem(child: Text('TMK'), value: 0),
              DropdownMenuItem(child: Text('KIN'), value: 1),
              DropdownMenuItem(child: Text('TBT'), value: 2),
              DropdownMenuItem(child: Text('ILA'), value: 3),
            ],
            onChanged: (val) {
...
Widget placeHolderWidget(
    ...
    AlignmentGeometry? alignment,
    double? radius}) {
  return Image.asset('images/walletApp/placeholder.jpg',
          height: height,
          width: width,
