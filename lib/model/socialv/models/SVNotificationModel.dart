...
List<SVNotificationModel> getNotificationsToday() {
  ...
  list.add(SVNotificationModel(
    ...
    postImage: '$OldBaseUrl/images/socialv/posts/post_one.png',
    isOfficial: false,
  ));
  list.add(SVNotificationModel(
    name: 'Bea_Mine',
...
List<SVNotificationModel> getNotificationsThisMonth() {
  ...
  list.add(SVNotificationModel(
    ...
    notificationType: SVNotificationType.like,
    postImage: '$OldBaseUrl/images/socialv/posts/post_two.png',
    isOfficial: true,
  ));
  list.add(SVNotificationModel(
    name: 'Anne Ortha',
  ...
  list.add(SVNotificationModel(
    ...
    postImage: '$OldBaseUrl/images/socialv/posts/post_three.png',
    isOfficial: true,
  ));
