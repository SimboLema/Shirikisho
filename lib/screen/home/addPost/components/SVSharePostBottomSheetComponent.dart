  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            svCommonCachedNetworkImage('$OldBaseUrl/images/socialv/posts/post_one.png', height: 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(SVAppCommonRadius),
            10.width,
            Container(
        ...
        Container(
          ...
          child: AppTextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: secondaryTextStyle(color: svGetBodyColor()),
              prefixIcon: Image.asset('assets/socialv/icons/ic_Search.png', height: 16, width: 16, fit: BoxFit.cover, color: svGetBodyColor()).paddingAll(16),
            ),
          ),
        ),
        16.height,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        6.width,
                        e.isOfficialAccount.validate() ? Image.asset('assets/socialv/icons/ic_TickSquare.png', height: 14, width: 14, fit: BoxFit.cover) : Offstage(),
                      ],
                      mainAxisSize: MainAxisSize.min,
                    ),
                  ],
