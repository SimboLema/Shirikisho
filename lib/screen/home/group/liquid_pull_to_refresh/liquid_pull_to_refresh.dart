...
import 'package:shirikisho/screen/home/group/liquid_pull_to_refresh/src/circular_progress.dart';
import 'package:shirikisho/screen/home/group/liquid_pull_to_refresh/src/clipper.dart';
...
class LiquidPullToRefreshState extends State<LiquidPullToRefresh> with TickerProviderStateMixin<LiquidPullToRefresh> {
  ...
  void didChangeDependencies() {
    ...
    _valueColor = _positionController!.drive(
      ColorTween(begin: (widget.color ?? WAPrimaryColor).withOpacity(0.0), end: (widget.color ?? WAPrimaryColor).withOpacity(1.0))
  ...
  Widget build(BuildContext context) {
    ...
    Color _defaultColor = WAPrimaryColor;
