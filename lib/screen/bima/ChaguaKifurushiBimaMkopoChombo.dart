...
class ChoosePlanMkopoChomboScreen extends StatefulWidget {
  @override
  ChoosePlanMkopoChomboScreenState createState() => ChoosePlanMkopoChomboScreenState();
}
class ChoosePlanMkopoChomboScreenState extends State<ChoosePlanMkopoChomboScreen> {
  List<BimaPackageModal> periodModal = [];
  int selectIndex = 0;
  int selectedMonthIndex = -1;
  List<String> monthOptions = [ "6", "12"];
  ...
  double calculateTotalAmount() {
    if (selectedMonthIndex == -1 || selectedMonthIndex >= monthOptions.length)
      return 0;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Chagua Bima',
                            style:
                                boldTextStyle(size: 24, color: WAPrimaryColor))
                        .paddingLeft(16.0),
                    16.height,
                    ListView.builder(
                      ...
                      itemBuilder: (_, int index) {
                        ...
                        } else if (periodModal[index].name?.toLowerCase() ==
                            "silver") {
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        DescriptionText(
                                          text:
                                              'Faida: ${periodModal[index].description.validate()}',
                                        ),
                                      ],
                                    ),
                                  ),
                      ...
                      itemBuilder: (_, int index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Card(
                            ...
                            color: isSelected
                                ? WAPrimaryColor.withOpacity(0.8)
                                : context.cardColor,
                            child: Center(
                              child: Text(
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style:
                                boldTextStyle(size: 20, color: WAPrimaryColor),
                          ),
                          16.height,
                          ElevatedButton(
                            ...
                            onPressed: () {
                              if (selectIndex != -1 &&
                                ...
                                String selectedPackage =
                                    periodModal[selectIndex].name ?? '';
                                String packageId =
                                    periodModal[selectIndex].id.toString();
                                double packagePrice =
                                    periodModal[selectIndex].price!.toDouble();
                                int selectedMonth =
                                    monthOptions[selectedMonthIndex].toInt();
    ...
    return Column(
      ...
      children: [
        Text(
          text.length > 50
              ? text.substring(0, 50) + '...'
              : text, // Show a limited portion of the text
