...
import 'package:shirikisho/component/WACardComponent.dart';
import 'package:shirikisho/component/WATransactionComponent.dart';
import 'package:shirikisho/component/WAWalletUserListComponent.dart';
                  ...
                  child: PageView(
                    ...
                    children: walletList.map((WACardModel item) {
                      return Container(
                        ...
                        child: WACardComponent(cardModel: item).paddingOnly(right: 16),
                      );
                    }).toList(),
                    onPageChanged: (index) {
                      setState(() {
